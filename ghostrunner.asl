...
update
{
	...
	{	vars.lstart = false;
		...
		{	vars.sections[vars.section, 2] = 1;
			...
			if(vars.section == 1 || vars.section == 7 || vars.section == 8 || vars.section == 11 || vars.section == 16 || vars.section == 17 ||  vars.section == 24 || vars.section == 28 || vars.section == 29 || vars.section == 30)
				vars.reachEOL = true;
			if(vars.section == 21 && !settings["killscounter"])
				vars.reachEOL = true;
			if(vars.section == 23 && settings["killscounter"])	
				vars.reachEOL = true;
		} else 
